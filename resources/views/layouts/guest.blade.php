...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 dark:text-gray-100 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
            <div>
                <a href="/">
                    <x-application-logo class="w-20 h-20 fill-current text-indigo-600 dark:text-indigo-500" />
                </a>
            </div>
            <div class="flex items-center justify-center mb-0 mt-4">
                <span class="ml-3 text-3xl font-bold text-gray-800 dark:text-white tracking-tight">Marriott<span class="text-indigo-600 dark:text-indigo-500">Connect</span></span>
            </div>
