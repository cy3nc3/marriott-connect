<div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-2">
            ...
            <span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full {{ $step >= 4 ? 'text-indigo-600 bg-indigo-200' : 'text-gray-600 bg-gray-200' }}">
                Step 4: Complete
            </span>
        </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        ...
        @if($step === 3)
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 border border-gray-200 p-4 rounded-md mb-6">
                    <h4 class="font-bold text-gray-700 mb-2 border-b pb-2">Assessment Summary</h4>
                    ...
                    <div class="border-t border-gray-300 mt-2 pt-2 flex justify-between text-lg font-bold text-indigo-900">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select wire:model.live="discountType" id="discountType" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
        ...
        @if($step === 4)
            <div class="text-center py-10 space-y-6">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Enrollment Complete!</h2>
                <p class="text-gray-600">The student has been successfully enrolled in the system.</p>
