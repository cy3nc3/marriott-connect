<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            <h2 class="text-lg font-medium text-gray-900 mb-4">Search Active Student</h2>
        ...
        @if($selectedStudent)
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in-down">
                ...
                <div class="col-span-1">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-indigo-500">
                        <div class="flex items-center justify-center mb-4">
                            <div class="h-20 w-20 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-3xl">
                                {{ substr($selectedStudent['name'], 0, 1) }}
                            </div>
                        </div>
                        <h3 class="text-xl font-bold text-center text-gray-900">{{ $selectedStudent['name'] }}</h3>
                        <p class="text-center text-gray-500 text-sm mb-4">{{ $selectedStudent['lrn'] }}</p>

                        <div class="border-t border-gray-100 pt-4 space-y-2">
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Grade Level:</span>
                                <span class="font-medium text-gray-900">{{ $selectedStudent['grade_level'] }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Section:</span>
                                <span class="font-medium text-gray-900">{{ $selectedStudent['section'] }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Status:</span>
                                <span class="font-medium text-green-600">{{ $selectedStudent['status'] }}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-span-1 md:col-span-2">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-6 border-b pb-2">Departure Details</h3>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select wire:model="reason" id="reason" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <div>
                                    ...
                                    <x-text-input wire:model="effectivityDate" id="effectivityDate" class="block mt-1 w-full" type="date" />
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100">
                                <div>
                                    <span class="block text-sm font-medium text-gray-700">Transfer Credentials Released?</span>
                                    <span class="block text-xs text-gray-500">Has the SF10/Good Moral been given?</span>
                                </div>
                            ...
                            <div>
                                ...
                                <textarea wire:model="remarks" id="remarks" rows="4" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Additional details..."></textarea>
