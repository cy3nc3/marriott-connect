    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-lg font-semibold text-gray-800">Academic Calendar Management</h3>
                        ...
                        @foreach ($school_years as $year)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center space-x-4">
                                        <div class="flex items-center">
                                            ...
                                            >
                                            <span class="ml-2 text-sm {{ $year['status'] === 'active' ? 'font-bold text-green-600' : 'text-gray-500' }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <span class="ml-2 text-sm {{ $year['admissions_open'] ? 'text-green-600 font-medium' : 'text-gray-500' }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <button wire:click="edit({{ $year['id'] }})" class="text-indigo-600 hover:text-indigo-900 mr-3">
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div x-show="open"
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    ...
                    <button wire:click="$set('showModal', false)" type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">
                        Cancel
                    </button>
                </div>
            </div>
