<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
    ...
    <!-- Main Content -->
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg border border-gray-500/15 dark:border-transparent transition-colors duration-300">
