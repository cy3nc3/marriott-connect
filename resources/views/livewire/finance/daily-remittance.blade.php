<div class="py-12">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Daily Collection Report</h2>
                <p class="text-lg text-gray-600 mt-1">{{ $date }}</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-green-500">
                <div class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-1">Total Collected</div>
                <div class="text-3xl font-extrabold text-green-600 print-color-green">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-blue-500">
                <div class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-1">Cash on Hand</div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-indigo-500">
                <div class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-1">Digital / Bank</div>
                <div class="text-2xl font-bold text-gray-800">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <h3 class="text-lg font-medium text-gray-900">Collection Breakdown</h3>
            </div>
            <div class="p-6">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr>
                            ...
                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Transaction Count</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($breakdown as $category => $data)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-600">{{ $data['count'] }}</td>
                    ...
                    <tfoot class="bg-gray-50">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right font-bold text-green-600 print-color-green">
                                ₱{{ number_format($totalCollected, 2) }}
                            </td>
                        </tr>
                    </tfoot>
