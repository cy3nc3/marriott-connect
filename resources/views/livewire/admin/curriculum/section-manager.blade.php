<div class="py-12" x-data="{ open: false }"
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <!-- Header & Actions -->
            <div class="p-6 border-b border-gray-200 bg-gray-50 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                <div class="flex items-center space-x-4">
                    <h3 class="text-lg font-medium text-gray-900">Section Management</h3>

                    <!-- Filter Dropdown -->
                    <div class="flex items-center space-x-2">
                        <label for="filterGrade" class="text-sm font-medium text-gray-700">Filter by Grade:</label>
                        <select wire:model.live="filterGrade" id="filterGrade" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($filteredSections as $section)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-700">{{ $section['capacity'] }} Students</td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                    <button wire:click="editSection({{ $section['id'] }})" class="text-indigo-600 hover:text-indigo-900">
                                        <i class='bx bx-edit text-xl'></i>
                                    </button>
                                    <button wire:click="deleteSection({{ $section['id'] }})" wire:confirm="Are you sure you want to delete this section?" class="text-red-600 hover:text-red-900">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <select wire:model="grade_level" id="grade_level" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="7">Grade 7</option>
                                <option value="8">Grade 8</option>
                                <option value="9">Grade 9</option>
                                <option value="10">Grade 10</option>
                        ...
                        <div>
                            ...
                            <select wire:model="adviser" id="adviser" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
