        ...
        @foreach ([7, 8, 9, 10] as $grade)
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    <h3 class="text-lg font-medium text-gray-900">Grade {{ $grade }} Subjects</h3>
                    <button
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Descriptive Title</th>
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Hours/Week</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @forelse($gradeSubjects as $subject)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">{{ $subject['hours'] }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-4 text-center text-gray-500">No subjects found for Grade {{ $grade }}.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
